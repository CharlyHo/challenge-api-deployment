...
with st.form("prediction_form"):
    ...
    with col1:
        ...
        subtype_encoded = st.selectbox("Subtype property", ["HOUSE", "VILLA", "APARTMENT", "STUDIO", "PENTHOUSE", "DUPLEX"])
    ...
    with col2:
        ...
        hasTerrace_encoded = st.checkbox("Terrasse")
        has_parking = st.checkbox("Parking")
        epcScore_encoded = st.slider("Estimate epcScore (1=G ➜ 9=A++)", min_value=1, max_value=9, value=5)
...
if submitted:
    input_data = {
        ...
        "subtype of property": subtype_encoded,
        "rooms-number": rooms,
        "zip-code": zip_code,
        ...
        "terrace": hasTerrace_encoded,
        "terrace-area": 10 if hasTerrace_encoded else 0,
        "building condition": condition,
        "parking": has_parking,
        "epcScore": epcScore_encoded
    }
